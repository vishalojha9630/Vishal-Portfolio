export const profile = {
  name: "Vishal Ojha",
  roleLabel: "VISHAL OJHA",
  role: "Senior Frontend Developer",
  tagline: "Senior Frontend Developer Building Scalable Web & Mobile Application",
  bio: "I design high-performance frontends, enterprise-grade dashboards, and production web & mobile systems that serve real users at scale.",
  location: "Dehradun IN",
  availability: "Open to impactful engineering opportunities",
...
export const siteSections = [
  ...
  { id: "resume-github", label: "Resume + GitHub" },
...
export const statsOverview = [
  {
    ...
    subtext: "React.js • React Native • Next.js",
  },
  {
    label: "LOCATION",
    value: "Dehradun IN",
    subtext: "Available for Remote & Hybrid",
  },
  // {
  //   label: "AVAILABILITY",
  //   value: "Open to impactful engineering opportunities",
  //   subtext: "Full-time & Senior Contract",
  // },
];
